                    ...
                    <div className='footer'>
                        <div className='copyrightFooter copyrightAn1'>
                          <div className='copyright '>
                                ...
                                <h3>THE CHRIST MIRACLE CHURCH INT</h3>
                          </div>
                          <p>COPYRIGHT 2020. THE CHRIST MIRACLE CHURCH INT. ALL RIGHTS RESERVED</p>
                        </div>
                        ...
                        <div className='conatactFooter copyrightAn3'>
                            ...
                            <div className='lastFooter'>
                               <img style={{width: '30px'}} src={require('../../pic/email.png')}/><p>PayitForwardInvestment@gmail.com</p>
                            </div>
                            <div className='lastFooter'>
